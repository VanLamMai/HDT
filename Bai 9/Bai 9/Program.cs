...
namespace Bai_9
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            string[] salePersonName = new string[] { "Danielle", "Edward", "Francis" };
            ...
            do
            {
                ...
                {
                    Console.Clear();
                    Console.WriteLine("=========================== Home Sales ===================================\n");
                    Console.WriteLine("Nhap z hoac Z de dung nhap hoac xuat ket qua");
                    Console.WriteLine("\n---------------------------------------------------------------------\n");
                    ...
                    {
                        Console.Clear();
                        Console.Write("\nNhap so hang ma {0} da ban duoc:", salePersonName[0]);
                    ...
                    {
                        Console.Clear();
                        Console.Write("\nNhap so hang ma {0} da ban duoc:", salePersonName[1]);
                        luongHang = int.Parse(Console.ReadLine());
                        Console.Write("\nNhap don gia cua mat hang:");
                        soTien = double.Parse(Console.ReadLine());
                    ...
                    {
                        Console.Clear();
                        Console.Write("\nNhap so hang ma {0} da ban duoc", salePersonName[2]);
                        luongHang = int.Parse(Console.ReadLine());
                        Console.Write("\nNhap don gia cua mat hang:");
                        soTien = double.Parse(Console.ReadLine());
